...
In order to support loading of multiple wallets in instadex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is instadex.cpp.
...
Changes to instadex.cpp
----------------------
instadex.cpp is the entry point into instadex-qt, and as such, will require some minor modifications to provide hooks for
