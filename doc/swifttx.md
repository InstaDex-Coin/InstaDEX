...
This mechanism has been integrated into Bitcore-Node-InstaDEX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PIVX-Project/insight-api-instadex#web-socket-api](https://github.com/PIVX-Project/insight-api-instadex#web-socket-api) 
* API: [https://github.com/PIVX-Project/insight-api-instadex#swifttx-transactions](https://github.com/PIVX-Project/insight-api-instadex#swifttx-transactions) 
...
By default, the InstaDEX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the InstaDEX Core daemon:
