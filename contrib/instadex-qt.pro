...
RESOURCES += src/qt/instadex.qrc src/qt/instadex_locale.qrc

TRANSLATIONS += src/qt/locale/instadex_bg.ts \
                src/qt/locale/instadex_de.ts \
                src/qt/locale/instadex_en.ts \
                src/qt/locale/instadex_es.ts \
                src/qt/locale/instadex_fi.ts \
                src/qt/locale/instadex_fr.ts \
                src/qt/locale/instadex_it.ts \
                src/qt/locale/instadex_ja.ts \
                src/qt/locale/instadex_pl.ts \
                src/qt/locale/instadex_pt.ts \
                src/qt/locale/instadex_ru.ts \
                src/qt/locale/instadex_sk.ts \
                src/qt/locale/instadex_sv.ts \
                src/qt/locale/instadex_vi.ts \
                src/qt/locale/instadex_zh_CN.ts \
                src/qt/locale/instadex_zh_TW.ts
