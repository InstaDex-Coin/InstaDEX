...
This means one can have an always-on instadexd instance running, and another local instadexd/instadex-qt instance which connects to this node and receives blocks from it.
