Contributing to InstaDEX Core
============================

The InstaDEX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the InstaDEX Core project, and is not to be
confused with overall InstaDEX Network Protocol consensus changes.

Whether a pull request is merged into InstaDEX Core rests with the project merge
...
Patches that change InstaDEX consensus rules are considerably more involved than
...
Where a patch set proposes to change the InstaDEX consensus, it must have been
...
The project leader is the release manager for each InstaDEX Core release.
