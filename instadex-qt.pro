...
TRANSLATIONS = $$files(src/qt/locale/instadex_*.ts)
...
windows:RC_FILE = src/qt/res/instadex-qt-res.rc
...
macx:ICON = src/qt/res/icons/instadex.icns
macx:TARGET = "instadex-Qt"
