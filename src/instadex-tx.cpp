...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("InstaDEX Core instadex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  instadex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded instadex transaction") + "\n" +
                               "  instadex-tx [options] -create [commands]   " + _("Create hex-encoded instadex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded instadex transaction
