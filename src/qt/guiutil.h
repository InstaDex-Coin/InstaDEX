...
/** Utility functions used by the InstaDEX Qt UI.
 */
namespace GUIUtil
{
...
// Render InstaDEX addresses in monospace font
...
// Parse "instadex:" URI into recipient object, return true on successful parsing
