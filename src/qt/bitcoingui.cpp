                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("InstaDEX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a InstaDEX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and instadex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About InstaDEX Core"), this);
    aboutAction->setStatusTip(tr("Show information about InstaDEX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for InstaDEX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your InstaDEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified InstaDEX addresses"));
    ...
    openAction->setStatusTip(tr("Open a InstaDEX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the InstaDEX Core help message to get a list with possible InstaDEX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("InstaDEX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to InstaDEX network", "", count));
}
...
{
    QString strTitle = tr("InstaDEX Core"); // default title
