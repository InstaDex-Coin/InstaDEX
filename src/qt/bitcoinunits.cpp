...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case INDEX:
        return QString("instadex");
    case mINDEX:
        return QString("minstadex");
    case uINDEX:
        return QString::fromUtf8("uinstadex");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case INDEX:
            return QString("INDEX");
        case mINDEX:
            return QString("Milli-INDEX (1 / 1" THIN_SP_UTF8 "000)");
        case uINDEX:
            return QString("Micro-INDEX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
