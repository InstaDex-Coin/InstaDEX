...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("InstaDEX Core"),
     ...
     * override -datadir in the instadex.conf file in the default data directory
     * (to be consistent with instadexd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
