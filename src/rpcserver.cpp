...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop InstaDEX server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "InstaDEX server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* InstaDEX features */
        {"InstaDEX", "masternode", &masternode, true, true, false},
        {"InstaDEX", "masternodelist", &masternodelist, true, true, false},
        {"InstaDEX", "mnbudget", &mnbudget, true, true, false},
        {"InstaDEX", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"InstaDEX", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"InstaDEX", "mnsync", &mnsync, true, true, false},
        {"InstaDEX", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"InstaDEX", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use InstaDEXd, or the -server option to InstaDEX-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"InstaDEX Alert\" admin@foo.com\n"),
...
{
    return "> InstaDEX-cli " + methodname + " " + args + "\n";
}
